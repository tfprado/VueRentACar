You can access the current page object via this.page and it returns the object Cms\Classes\Page. This object can also be [accessed in the PHP code](../Pages.md#page-variables).
