The `{% content %}` tag will display a [CMS content block](../content-blocks.md) on the page. To display content block called contacts.htm you pass the file name after the content tag quoted as a string.
