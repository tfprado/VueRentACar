...
The **validation.php** file has a similar structure to the **lang.php** and is used to specify your [custom validation](../services/validation.md#localization) messages in a language file, for example:
...
Next: [Task scheduling](scheduling.md)

Previous: [Settings & Config](settings.md)
